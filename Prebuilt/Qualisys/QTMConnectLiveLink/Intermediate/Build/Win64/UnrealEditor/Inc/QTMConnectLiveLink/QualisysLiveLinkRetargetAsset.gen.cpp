...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DebugTPose_MetaData[];
#endif
		static void NewProp_DebugTPose_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_DebugTPose;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_ValueProp = { "BoneMapping", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_Key_KeyProp = { "BoneMapping_Key", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_MetaData[] = {
		{ "Category", "Bone Mapping" },
		{ "ModuleRelativePath", "Public/QualisysLiveLinkRetargetAsset.h" },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping = { "BoneMapping", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UQualisysLiveLinkRetargetAsset, BoneMapping), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_DebugTPose_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Public/QualisysLiveLinkRetargetAsset.h" },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_DebugTPose = { "DebugTPose", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UQualisysLiveLinkRetargetAsset), &Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_DebugTPose_SetBit, METADATA_PARAMS(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_DebugTPose_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_DebugTPose_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_ValueProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_Key_KeyProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_DebugTPose,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UQualisysLiveLinkRetargetAsset()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UQualisysLiveLinkRetargetAsset, 2948460543);
