...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_DebugTPose = { UE4CodeGen_Private::EPropertyClass::Bool, "DebugTPose", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UQualisysLiveLinkRetargetAsset), &Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_DebugTPose_SetBit, METADATA_PARAMS(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_DebugTPose_MetaData, ARRAY_COUNT(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_DebugTPose_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping = { UE4CodeGen_Private::EPropertyClass::Map, "BoneMapping", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UQualisysLiveLinkRetargetAsset, BoneMapping), METADATA_PARAMS(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_MetaData, ARRAY_COUNT(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_MetaData)) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_Key_KeyProp = { UE4CodeGen_Private::EPropertyClass::Name, "BoneMapping_Key", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000001, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::NewProp_BoneMapping_ValueProp = { UE4CodeGen_Private::EPropertyClass::Name, "BoneMapping", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000001, 1, nullptr, 1, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::ClassParams = {
		...
		0x001000A0u,
		nullptr, 0,
		Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::PropPointers),
		nullptr,
		&StaticCppClassTypeInfo,
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UQualisysLiveLinkRetargetAsset_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UQualisysLiveLinkRetargetAsset, 1370851856);
