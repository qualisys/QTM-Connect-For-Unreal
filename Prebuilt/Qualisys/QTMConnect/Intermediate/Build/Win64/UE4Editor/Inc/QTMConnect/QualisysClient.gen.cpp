...
static struct FScriptStruct_QTMConnect_StaticRegisterNativesFQualisysRigidBodyInfo
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FQualisysRigidBodyInfo_Hash() { return 3643420204U; }
...
static struct FScriptStruct_QTMConnect_StaticRegisterNativesFQualisysTrajectoryInfo
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AQualisysClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AQualisysClient_FindQualisysClient, "FindQualisysClient" }, // 1451479706
		{ &Z_Construct_UFunction_AQualisysClient_GetMarkerPosition, "GetMarkerPosition" }, // 4267159448
		{ &Z_Construct_UFunction_AQualisysClient_GetRigidBody, "GetRigidBody" }, // 1833117754
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AQualisysClient, 3727838747);
