...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_QualisysClient_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_QualisysClient;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UQualisysTrajectory_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_Name_MetaData[] = {
		{ "Category", "Qualisys" },
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UQualisysTrajectory, Name), METADATA_PARAMS(Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_QualisysClient_MetaData[] = {
		{ "Category", "Qualisys" },
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_QualisysClient = { "QualisysClient", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UQualisysTrajectory, QualisysClient), Z_Construct_UClass_AQualisysClient_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_QualisysClient_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_QualisysClient_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UQualisysTrajectory_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_Name,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_QualisysClient,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UQualisysTrajectory_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UQualisysTrajectory()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UQualisysTrajectory_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UQualisysTrajectory, 410735064);
