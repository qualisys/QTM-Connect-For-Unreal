...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UQualisysRigidBody_Statics::NewProp_QualisysClient = { UE4CodeGen_Private::EPropertyClass::Object, "QualisysClient", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010040000000005, 1, nullptr, STRUCT_OFFSET(UQualisysRigidBody, QualisysClient), Z_Construct_UClass_AQualisysClient_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UQualisysRigidBody_Statics::NewProp_QualisysClient_MetaData, ARRAY_COUNT(Z_Construct_UClass_UQualisysRigidBody_Statics::NewProp_QualisysClient_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UQualisysRigidBody_Statics::NewProp_Name = { UE4CodeGen_Private::EPropertyClass::Name, "Name", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UQualisysRigidBody, Name), METADATA_PARAMS(Z_Construct_UClass_UQualisysRigidBody_Statics::NewProp_Name_MetaData, ARRAY_COUNT(Z_Construct_UClass_UQualisysRigidBody_Statics::NewProp_Name_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UQualisysRigidBody_Statics::ClassParams = {
		...
		0x00B000A4u,
		nullptr, 0,
		Z_Construct_UClass_UQualisysRigidBody_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UQualisysRigidBody_Statics::PropPointers),
		"Engine",
		&StaticCppClassTypeInfo,
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_UQualisysRigidBody_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UQualisysRigidBody_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UQualisysRigidBody, 2077910178);
