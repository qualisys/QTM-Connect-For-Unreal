...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_QualisysClient = { "QualisysClient", nullptr, (EPropertyFlags)0x0010040000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UQualisysTrajectory, QualisysClient), Z_Construct_UClass_AQualisysClient_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_QualisysClient_MetaData, ARRAY_COUNT(Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_QualisysClient_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UQualisysTrajectory, Name), METADATA_PARAMS(Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_Name_MetaData, ARRAY_COUNT(Z_Construct_UClass_UQualisysTrajectory_Statics::NewProp_Name_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UQualisysTrajectory_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UQualisysTrajectory_Statics::PropPointers),
		0,
		0x00B000A4u,
	...
	IMPLEMENT_CLASS(UQualisysTrajectory, 2991297737);
